...
const Services: React.FC = () => {
  return (
    <div id="services" className="bg-gray-50 pt-2 pb-8 md:pt-2 md:pb-12 reveal scroll-mt-28">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">

        {/* Full-width Image */}
        <div className="w-full bg-white mb-6">
          <img
            src="https://pub-e275050976b44ce6a57233bbbfab851a.r2.dev/containers_np.jpeg"
        ...
        {/* Content Section */}
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 text-center md:text-left">Our Services</h2>
